                ...
                {message.role === 'user' ? (
                  ...
                  <div className="flex justify-start w-full max-w-[90%]">
                    {typeof message.content === 'string' ? (
                      ...
                      <div className="w-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl rounded-tl-md p-6 shadow-2xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-3xl transition-shadow duration-300">

...
export const useAppStore = create<AppState>((set) => ({
  ...
  theme: (typeof window !== 'undefined' && window.localStorage && typeof window.localStorage.getItem === 'function' ? window.localStorage.getItem('theme') as 'light' | 'dark' | 'system' : 'light'),
  setTheme: (theme) => {
    set({ theme });
  },

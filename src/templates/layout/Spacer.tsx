...
const Spacer: React.FC<SpacerProps> = ({
  ...
  if (showIndicator) {
    return (
      <div
        className={`${sizeClasses[orientation][size]} ${orientationClass} ${flexibleClass} border-2 border-dashed border-indigo-600 rounded flex items-center justify-center`}
        style={style}
      >

...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 active:from-orange-700 active:to-pink-700 text-white shadow-[0_0_0_1px_rgba(255,255,255,0.1)_inset,0_2px_8px_rgba(249,115,22,0.3)] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.2)_inset,0_4px_16px_rgba(249,115,22,0.4)]',
    secondary: 'bg-zinc-800 hover:bg-zinc-700 active:bg-zinc-900 text-white dark:bg-zinc-700 dark:hover:bg-zinc-600 shadow-[0_0_0_1px_rgba(255,255,255,0.05)_inset,0_1px_2px_rgba(0,0,0,0.2)]',
    outline: 'border border-zinc-200 dark:border-zinc-700 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm text-zinc-900 dark:text-zinc-100 hover:bg-zinc-50 dark:hover:bg-zinc-800 shadow-sm hover:shadow-md',
    ...
    success: 'bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 text-white shadow-[0_0_0_1px_rgba(255,255,255,0.1)_inset,0_2px_4px_rgba(16,185,129,0.3)]',
  };

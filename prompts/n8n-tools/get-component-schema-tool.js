...
const components = {
  "area-chart": {
    ...
    "props": {
      ...
      "data": {
        "type": "string",
        "description": "Object-array format: [{month: \"Jan\", revenue: 42000, expenses: 38000}, ...]",
        "required": false,
        "tsType": "Record<string, string | number>[]"
      },
      "xKey": {
        "type": "string",
        "description": "",
  ...
  "line-chart": {
    ...
    "props": {
      ...
      "data": {
        "type": "string",
        "description": "Object-array format: [{month: \"Jan\", sales: 4200, returns: 380}, ...]",
        "required": false,
        "tsType": "Record<string, string | number>[]"
      },
      "xKey": {
        "type": "string",
        "description": "Key in data objects used as x-axis categories (required with data)",
        "required": false,
        "tsType": "string"
      },
      "seriesKeys": {
        "type": "string",
        "description": "Explicit keys to extract as series; defaults to all numeric keys except xKey",
        "required": false,
        "tsType": "string[]"
      }
    },
  ...
  "map": {
    ...
    "props": {
      ...
      "tileLayer": {
        "type": "'streets' | 'dark' | 'satellite' | 'light'",
        "description": "",
        "required": false,
        "tsType": "'streets' | 'dark' | 'satellite' | 'light'"
      },
      "markers": {
        "type": "array",
        "description": "",
